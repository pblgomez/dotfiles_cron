# Generated by Powerlevel10k configuration wizard on 2021-06-23 at 18:52 WEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 25238.
# Wizard options: awesome-fontconfig + powerline, large icons, rainbow, ascii, 1 line,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|kubecolor|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'
